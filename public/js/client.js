...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        // title: 'Meetoo',
        position: 'top',
        title: '<div><img style="position: relative; right: 1%;" width="50" src="../images/meetoo.png" alt="Meetoo"> Meetoo</div>',
        customClass: {
    ...
    joinButton.addEventListener("click", async function() {
        ...
        if (!inputValue) return 'Please enter your name';
        // Long name
        if (inputValue.length > 30) return 'Name must be max 30 char';

        // prevent xss execution itself
        myPeerName = filterXSS(inputValue);
